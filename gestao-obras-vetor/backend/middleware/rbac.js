...
const PERMISSIONS = {
  ...
  FOLHAS_VERIFICACAO_VIEW: 'folhas_verificacao.view',
  FOLHAS_VERIFICACAO_CREATE: 'folhas_verificacao.create',
  FOLHAS_VERIFICACAO_APPROVE: 'folhas_verificacao.approve',
  FOLHAS_VERIFICACAO_REJECT: 'folhas_verificacao.reject',
  FOLHAS_VERIFICACAO_MODELS_MANAGE: 'folhas_verificacao.models.manage',
  FOLHAS_VERIFICACAO_INSTRUMENT_RELEASE: 'folhas_verificacao.instrument.release'
};
...
const permissionMatrix = {
  ...
  [PERMISSIONS.FOLHAS_VERIFICACAO_VIEW]: [PERFIS.GESTOR_GERAL, PERFIS.GESTOR_OBRA, PERFIS.GESTOR_QUALIDADE, PERFIS.FISCAL, PERFIS.ADM],
  [PERMISSIONS.FOLHAS_VERIFICACAO_CREATE]: [PERFIS.GESTOR_GERAL, PERFIS.GESTOR_OBRA, PERFIS.GESTOR_QUALIDADE, PERFIS.FISCAL],
  [PERMISSIONS.FOLHAS_VERIFICACAO_APPROVE]: [PERFIS.GESTOR_GERAL, PERFIS.GESTOR_OBRA, PERFIS.GESTOR_QUALIDADE],
  [PERMISSIONS.FOLHAS_VERIFICACAO_REJECT]: [PERFIS.GESTOR_GERAL, PERFIS.GESTOR_OBRA, PERFIS.GESTOR_QUALIDADE, PERFIS.FISCAL],
  [PERMISSIONS.FOLHAS_VERIFICACAO_MODELS_MANAGE]: [PERFIS.GESTOR_GERAL, PERFIS.GESTOR_QUALIDADE, PERFIS.ADM],
  [PERMISSIONS.FOLHAS_VERIFICACAO_INSTRUMENT_RELEASE]: [PERFIS.GESTOR_GERAL, PERFIS.GESTOR_OBRA, PERFIS.GESTOR_QUALIDADE]
};
