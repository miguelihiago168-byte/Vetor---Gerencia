    ...
    <div className="login-page">
      ...
      <div className="login-panel">
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div className="login-hint" style={{ marginTop: '12px', fontSize: '0.9rem' }}>
            <span style={{ color: 'var(--gray-600)' }}>Credenciais de exemplo:</span>
            <div><strong>Login:</strong> 000001 &nbsp; <strong>Senha:</strong> 123456</div>
          </div>
        </form>
      </div>
    </div>
