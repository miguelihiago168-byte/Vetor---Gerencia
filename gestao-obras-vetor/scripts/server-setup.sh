...
echo ""
echo " 3. Configure o dominio HTTPS (DNS apontado e portas 80/443 liberadas):"
echo "    cd /root/Vetor---Gerencia/gestao-obras-vetor"
echo "    cp .env.example .env"
echo "    nano .env   # defina APP_DOMAIN, LETSENCRYPT_EMAIL e APP_DATA_DIR"
echo ""
echo " 4. Crie o ambiente do backend:"
...
echo "    mkdir -p \"\$APP_DATA_DIR/database\" \"\$APP_DATA_DIR/uploads\""
echo "    sh scripts/validate_data_dir.sh \"\$APP_DATA_DIR\""
echo "    docker compose up -d --build"
echo ""
echo " 6. Verifique se tudo subiu:"
echo "    docker compose ps"
echo "    docker compose logs -f caddy"
echo "    docker compose exec -T frontend wget -qO- http://localhost/api/health"
...
echo ""
echo " 7. Acesse no browser: https://SEU_DOMINIO"
